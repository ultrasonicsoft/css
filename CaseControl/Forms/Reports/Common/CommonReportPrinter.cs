...
{
    public class CommonReportPrinter : DocumentPaginator
    {
        ...
        public CommonReportPrinter(DataGrid documentSource, string documentTitle, Size pageSize, Thickness pageMargin)
        {
        ...
        public override DocumentPage GetPage(int pageNumber)
        {
            ...
            if (viewSource != null)
            {
                CommonReportViewModel temp = new CommonReportViewModel();
                temp.ClientName = "==============";
                temp.FileNo = "========";
                temp.ByAttorney = "==========";
                temp.AccidentDate = "==========";
