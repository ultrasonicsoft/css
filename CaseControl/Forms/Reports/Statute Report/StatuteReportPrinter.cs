...
{
    public class StatuteReportPrinter : DocumentPaginator
    {
        #region Private Members

        private DataGrid _documentSource;
        private DataGrid _dg180Days;
        private DataGrid _dg1Year;
        private DataGrid _dg2Years;
        private DataGrid _dg3Years;
        private DataGrid _dg5Years;
        ...
        public StatuteReportPrinter(DataGrid dg60Days, DataGrid dg180Days, DataGrid dg1Year, DataGrid dg2Years, DataGrid dg3Years, DataGrid dg5Years,
                                        string documentTitle, Size pageSize, Thickness pageMargin)
        {
            _tableColumnDefinitions = new Collection<ColumnDefinition>();
            _documentSource = dg60Days;

            _dg180Days = dg180Days;
            _dg1Year = dg1Year;
            _dg2Years = dg2Years;
            _dg3Years = dg3Years;
            _dg5Years = dg5Years;
        ...
        /// <returns></returns>
        private double CountRows()
        {
            IEnumerable itemsSource = _documentSource.ItemsSource;
            int count = 0;
            ...
            itemsSource = _dg180Days.ItemsSource;
            if (itemsSource != null)
            {
                foreach (object item in itemsSource)
                { count++; }
            ...
            itemsSource = _dg1Year.ItemsSource;
            if (itemsSource != null)
            {
                foreach (object item in itemsSource)
                { count++; }
            ...
            itemsSource = _dg2Years.ItemsSource;
            if (itemsSource != null)
            {
                foreach (object item in itemsSource)
                { count++; }
            ...
            itemsSource = _dg3Years.ItemsSource;
            if (itemsSource != null)
            {
                foreach (object item in itemsSource)
                { count++; }
            ...
            itemsSource = _dg5Years.ItemsSource;
            if (itemsSource != null)
            {
                foreach (object item in itemsSource)
                { count++; }
